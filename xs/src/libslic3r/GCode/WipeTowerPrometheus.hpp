#ifndef WipeTowerPrometheus_hpp_
#define WipeTowerPrometheus_hpp_
...
class WipeTowerPrometheus : public WipeTower
{
public:
	enum material_type
	{
	...
	WipeTowerPrometheus(float x, float y, float width, float wipe_area, unsigned int initial_tool) :
...
#endif /* WipeTowerPrometheus_hpp_ */
